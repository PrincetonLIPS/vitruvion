#   Copyright 2019 Kuan Wang. Modifications copyright 2021 Wenda Zhou.
#
...
class MobileNetV3(nn.Module):
    def __init__(self, output_dim: int=1000, input_size: int=224, dropout=0.8, mode='small', width_multiplier: float=1.0, input_channels: int=3):
        """Create a new MobileNetV3
        """
        ...
        self.features = [conv_bn(input_channels, input_channel, 2, nlin_layer=Hswish)]
        self.classifier = []
